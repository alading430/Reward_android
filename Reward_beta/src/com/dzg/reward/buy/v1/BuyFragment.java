...
public class BuyFragment extends BaseFragment implements OnRefreshListener<ListView>{
	...
	private void loadData(){
		...
		header.tv_title_name.setText(R.string.main_buy);
		...
		plv.setOnRefreshListener(BuyFragment.this);
