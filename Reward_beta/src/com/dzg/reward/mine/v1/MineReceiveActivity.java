...
import com.dzg.reward.receive.v1.ReceiveResultActivity;
...
public class MineReceiveActivity extends TAActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.v1_mine_receive);
		context = this;
		loadView();
		loadData();
	}
	...
	class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if(convertView == null){
				convertView = inflater.inflate(R.layout.v1_mine_receive_listitem, null);
			}
