...
public class RewardFragment extends BaseFragment implements OnRefreshListener<ListView>{
	...
	private void loadData(){
		...
		header.tv_title_name.setText(R.string.main_reward);
		...
		plv.setOnRefreshListener(RewardFragment.this);
	...
	class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if(convertView == null){
				convertView = inflater.inflate(R.layout.v1_reward_listitem, null);
			}
