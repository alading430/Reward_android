...
public class SellFragment extends BaseFragment implements OnRefreshListener<ListView>{
	...
	private void loadData(){
		...
		header.tv_title_name.setText(R.string.main_sell);
		...
		plv.setOnRefreshListener(SellFragment.this);
	...
	class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if(convertView == null){
				convertView = inflater.inflate(R.layout.v1_sell_listitem, null);
			}
