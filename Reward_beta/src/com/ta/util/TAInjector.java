...
public class TAInjector
{
	...
	private void inject(View activity, Field field)
	{
		// TODO Auto-generated method stub
		try
		{
	...
	private void inject(Fragment activity, Field field)
	{
		// TODO Auto-generated method stub
		try
		{
	...
	private void injectView(View activity, Field field)
	{
		// TODO Auto-generated method stub
		if (field.isAnnotationPresent(TAInjectView.class))
		{
	...
	private void injectView(Fragment fragment, View activity, Field field)
	{
		// TODO Auto-generated method stub
		if (field.isAnnotationPresent(TAInjectView.class))
		{
			...
			{
				field.setAccessible(true);
				field.set(fragment, activity.findViewById(viewId));
			} catch (Exception e)
			{
				e.printStackTrace();
			}
	...
	private void injectResource(Fragment activity, Field field)
	{
		// TODO Auto-generated method stub
		if (field.isAnnotationPresent(TAInjectResource.class))
		{
	...
	public void inject(View activity)
	{
		// TODO Auto-generated method stub
		Field[] fields = activity.getClass().getDeclaredFields();
		if (fields != null && fields.length > 0)
	...
	public void inject(Fragment activity)
	{
		// TODO Auto-generated method stub
		Field[] fields = activity.getClass().getDeclaredFields();
		if (fields != null && fields.length > 0)
	...
	public void injectView(Fragment activity, View view)
	{
		// TODO Auto-generated method stub
		Field[] fields = activity.getClass().getDeclaredFields();
		if (fields != null && fields.length > 0)
		{
			for (Field field : fields)
			{
				if (field.isAnnotationPresent(TAInjectView.class))
				{
					injectView(activity, view, field);
				}
			}
		}
	}
	public void injectView(View activity)
	{
		// TODO Auto-generated method stub
		Field[] fields = activity.getClass().getDeclaredFields();
		if (fields != null && fields.length > 0)
	...
	public void injectResource(Fragment activity)
	{
		// TODO Auto-generated method stub
		Field[] fields = activity.getClass().getDeclaredFields();
		if (fields != null && fields.length > 0)
